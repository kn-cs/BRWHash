...
SRCFLS = ../source/brwhash1305_const.S 	\
	 ../source/brwhash1305_t2_maax.S	\
	 ../source/brwhash1305_keypowers.S	\
	 ../source/brwhash1305_input.c 	\
	 ../source/brwhash1305.c
         
OBJFLS = ../source/brwhash1305_const.o 	\
	 ../source/brwhash1305_t2_maax.o	\
	 ../source/brwhash1305_keypowers.o	\
	 ../source/brwhash1305_input.o 	\
	 ../source/brwhash1305.o

TESTSRC = ./brwhash1305_t2_verify.c
TESTOBJ = ./brwhash1305_t2_verify.o

SPEEDSRC = ./brwhash1305_t2_speed.c
SPEEDOBJ = ./brwhash1305_t2_speed.o

RECORDSRC = ./brwhash1305_t2_record_speed.c
RECORDOBJ = ./brwhash1305_t2_record_speed.o
	  
EXE1    = brwhash1305_t2_verify
EXE2    = brwhash1305_t2_speed
EXE3    = brwhash1305_t2_record_speed
