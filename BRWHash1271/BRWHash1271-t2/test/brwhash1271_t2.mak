...
SRCFLS = ../source/brwhash1271_const.S 	\
	 ../source/brwhash1271_t2_maax.S	\
	 ../source/brwhash1271_keypowers.S	\
	 ../source/brwhash1271_input.c 	\
	 ../source/brwhash1271.c
         
OBJFLS = ../source/brwhash1271_const.o 	\
	 ../source/brwhash1271_t2_maax.o	\
	 ../source/brwhash1271_keypowers.o	\
	 ../source/brwhash1271_input.o 	\
	 ../source/brwhash1271.o

TESTSRC = ./brwhash1271_t2_verify.c
TESTOBJ = ./brwhash1271_t2_verify.o

SPEEDSRC = ./brwhash1271_t2_speed.c
SPEEDOBJ = ./brwhash1271_t2_speed.o

RECORDSRC = ./brwhash1271_t2_record_speed.c
RECORDOBJ = ./brwhash1271_t2_record_speed.o
	  
EXE1    = brwhash1271_t2_verify
EXE2    = brwhash1271_t2_speed
EXE3    = brwhash1271_t2_record_speed
